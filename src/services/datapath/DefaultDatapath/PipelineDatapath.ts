...
export default class PipelineDatapath {
	...
	private createBlocks(): void {
		...
		this.constants.push(
			this.scene.createConstant(this.adds[0].x - 2, this.adds[0].y + 6, 4)
		)
		...
		this.adds.push(
			this.scene.createADD(this.adds[1].x, this.adds[1].y + this.adds[1].height)
		) // 2
		this.shiftLeft = this.scene.createShiftLeft(
			this.adds[2].x - 3.5,
			this.adds[2].y + 6
		)
		...
		this.muxs.push(
			this.scene.createMux(
				this.mux6s[1].x + this.mux6s[1].width + 3,
				this.mux6s[1].y + 1.5
			)
		) // 3
		...
		this.aluControl = this.scene.createALUControl(
			this.alu.x,
			this.alu.y + this.alu.height + 6
		)
		...
		this.constants.push(
			this.scene.createConstant(this.muxs[4].x - 2, this.muxs[4].y + 1, 1)
		)
		this.constants.push(
			this.scene.createConstant(this.muxs[4].x - 2, this.muxs[4].y + 4, 0)
		)
		this.muxs.push(
			this.scene.createMux(this.muxs[4].x, this.muxs[4].y - 6, false, true)
		) // 5
		this.adds.push(this.scene.createADD(this.muxs[5].x - 5, this.muxs[5].y - 2.5)) // 3
		this.shiftLeft12 = this.scene.createShiftLeft12(
			this.adds[3].x - 3.5,
			this.adds[3].y + 6
		)
		...
		this.dataGen = this.scene.createDataGen(
			this.dMem.x + this.dMem.width + 4,
			this.dMem.y + 2
		)
		...
		this.muxs.push(
			this.scene.createMux(
				this.buffers[3].x + this.buffers[3].width + 2,
				this.dataGen.y - 1
			)
		) // 6
		this.muxs.push(
			this.scene.createMux(
				this.muxs[6].x + this.muxs[6].width + 2,
				this.muxs[6].y - 1.5
			)
		) // 7
		this.muxs.push(
			this.scene.createMux(
				this.muxs[7].x + this.muxs[7].width + 2,
				this.muxs[4].y + 1.5
			)
		) // 8
		this.muxs.push(
			this.scene.createMux(
				this.muxs[8].x + this.muxs[8].width + 2,
				this.muxs[5].y + 1.5
			)
		) // 9
	}
	...
	private createLinks(): void {
		...
		const outBuffer0__section0__ins =
			buffer0__section0.getPort('output-Instruction')
		...
		const inBuffer1__section3__readData1 =
			buffer1__section3.getPort('input-ReadData1')
		const inBuffer1__section3__readData2 =
			buffer1__section3.getPort('input-ReadData2')
		const inBuffer1__section3__immGen = buffer1__section3.getPort('input-ImmGen')
		const inBuffer1__section3__funct3_7 =
			buffer1__section3.getPort('input-Funct3_7')
		...
		const mux2Port1 = this.links.createPort(
			mux2Port0.x,
			inBuffer1__section1__mem.y,
			{
				color: Scene.CONTROL_COLOR,
			}
		)
		...
		const mux2Port8 = this.links.createPort(
			mux2Port0.x,
			inBuffer1__section2__ex.y,
			{
				color: Scene.CONTROL_COLOR,
			}
		)
		mux2Port8.name = 'REG.EX'
		const mux2Port9 = this.links.createPort(
			mux2Port0.x,
			inBuffer1__section0__wb.y,
			{
				color: Scene.CONTROL_COLOR,
			}
		)
		...
		const outBuffer1__section2__auiOrLui =
			buffer1__section2.getPort('output-AuiOrLui')
		...
		const outBuffer1__section3__readData1 =
			buffer1__section3.getPort('output-ReadData1')
		const outBuffer1__section3__readData2 =
			buffer1__section3.getPort('output-ReadData2')
		const outBuffer1__section3__immGen = buffer1__section3.getPort('output-ImmGen')
		const outBuffer1__section3__funct3_7 =
			buffer1__section3.getPort('output-Funct3_7')
		...
		const inBuffer2__section2__auiOrLui =
			buffer2__section2.getPort('input-AuiOrLui')
		const inBuffer2__section2__slt = buffer2__section2.getPort('input-Slt')
		const inBuffer2__section2__aluResult =
			buffer2__section2.getPort('input-ALUResult')
		const inBuffer2__section2__readData2 =
			buffer2__section2.getPort('input-ReadData2')
		...
		this.createLink(
			bufferMemPort0,
			inDetec_control,
			[[bufferMemPort0.x, inDetec_control.y]],
			{
				color: Scene.CONTROL_COLOR,
			}
		)
		...
		const immGenPort2 = this.links.createPort(
			outBuffer1__section3__immGen.x + 1,
			inMux3_0.y
		)
		...
		const w_regPort0 = this.links.createPort(
			inMuxSix0_0.x,
			outBuffer1__section3__w_reg.y
		)
		...
		// Link Block to Block
		const shiftLeft12Port0 = this.links.createPort(
			outShiftLeft12.x + 0.75,
			outShiftLeft12.y
		)
		...
		this.createLink(
			outALUSignBit,
			inMux4_control,
			[[inMux4_control.x, outALUSignBit.y]],
			{
				color: Scene.CONTROL_COLOR,
			}
		)
		...
		this.createLink(
			outForward_0,
			inMuxSix0_control,
			[[inMuxSix0_control.x, outForward_0.y]],
			{
				color: Scene.CONTROL_COLOR,
			}
		)
		this.createLink(
			outForward_1,
			inMuxSix1_control,
			[[inMuxSix1_control.x, outForward_1.y]],
			{
				color: Scene.CONTROL_COLOR,
			}
		)
		...
		const outBuffer2__section1__MemWrite =
			buffer2__section1.getPort('output-MemWrite')
		const outBuffer2__section1__Unsigned =
			buffer2__section1.getPort('output-Unsigned')
		const outBuffer2__section1__MemRead =
			buffer2__section1.getPort('output-MemRead')
		const outBuffer2__section2__PC4 = buffer2__section2.getPort('output-PC4')
		const outBuffer2__section2__AuiOrLui =
			buffer2__section2.getPort('output-AuiOrLui')
		const outBuffer2__section2__Slt = buffer2__section2.getPort('output-Slt')
		const outBuffer2__section2__ALUResult =
			buffer2__section2.getPort('output-ALUResult')
		const outBuffer2__section2__ReadData2 =
			buffer2__section2.getPort('output-ReadData2')
		...
		const inBuffer3__section1__AuiOrLui =
			buffer3__section1.getPort('input-AuiOrLui')
		...
		const inBuffer3__section1__ALUResult =
			buffer3__section1.getPort('input-ALUResult')
		const inBuffer3__section1__W_reg = buffer3__section1.getPort('input-W_reg')

		const wbPort0 = this.links.createPort(
			outDataGen.x + 2,
			outBuffer2__section0__wb.y,
			{
				color: Scene.CONTROL_COLOR,
			}
		)
		...
		const sltPort1 = this.links.createPort(
			auiOrLuiPort1.x + 0.5,
			auiOrLuiPort1.y - 0.5
		)
		...
		this.createLink(auiOrLuiPort0, auiOrLuiPort1, [
			[auiOrLuiPort0.x, auiOrLuiPort1.y],
		])
		this.createLink(sltPort0, sltPort1, [[sltPort0.x, sltPort1.y]])
		this.createLink(aluResultPort1, aluResultPort2, [
			[aluResultPort1.x, aluResultPort2.y],
		])

		this.createLink(pc4Port1, pc4Port2, [[pc4Port1.x, pc4Port2.y]])
		this.createLink(auiOrLuiPort1, auiOrLuiPort2, [
			[auiOrLuiPort1.x, auiOrLuiPort2.y],
		])
		this.createLink(sltPort1, sltPort2, [[sltPort1.x, sltPort2.y]])
		this.createLink(aluResultPort2, aluResultPort3, [
			[aluResultPort2.x, aluResultPort3.y],
		])
		...
		this.createLink(aluResultPort3, inMuxSix0_0, [
			[aluResultPort3.x, inMuxSix0_0.y],
		])
		...
		const outBuffer3__section0__RegWrite =
			buffer3__section0.getPort('output-RegWrite')
		...
		const outBuffer3__section0__MemtoReg =
			buffer3__section0.getPort('output-MemtoReg')
		const outBuffer3__section1__PC4 = buffer3__section1.getPort('output-PC4')
		const outBuffer3__section1__AuiOrLui =
			buffer3__section1.getPort('output-AuiOrLui')
		...
		const outBuffer3__section1__ALUResult =
			buffer3__section1.getPort('output-ALUResult')
		...
		this.createLink(
			...
			[
				[
					outBuffer3__section0__RegWrite.x + 2,
					outBuffer3__section0__RegWrite.y,
				],
				[
					outBuffer3__section0__RegWrite.x + 2,
					outBuffer3__section0__RegWrite.y - 5,
				],
