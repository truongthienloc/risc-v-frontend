...
export default class PipelineDatapath {
    ...
    constructor(containerId: string, w: number, h: number, bgColor?: string) {
    ...
    private createBlocks(): void {
        ...
        this.buffers.push(
            this.scene.addBlock(
                new Buffer_01(this.scene.context, this.iMem.x + 8, this.iMem.y - 35),
            ),
        )
    ...
    private createLinks(): void {
        ...
        console.log('buffer0__section0: ', buffer0__section0);
        ...
        this.createLink(mux2Port0, inBuffer1__section2__ex, [], { color: Scene.CONTROL_COLOR })
        this.createLink(mux2Port1, inBuffer1__section1__mem, [], { color: Scene.CONTROL_COLOR })
        this.createLink(
            mux2Port1,
            inBuffer1__section0__wb,
            [[mux2Port1.x, inBuffer1__section0__wb.y]],
            { color: Scene.CONTROL_COLOR },
        )
        ...
        this.createLink(mux2Port5, mux2Port6, [], { color: Scene.CONTROL_COLOR })
        this.createLink(mux2Port6, mux2Port7, [], { color: Scene.CONTROL_COLOR })
        this.createLink(mux2Port4, inBranch_Wb, [[inBranch_Wb.x, mux2Port4.y]], {
            color: Scene.CONTROL_COLOR,
        })
        this.createLink(mux2Port4, inBranch_Jump, [], { color: Scene.CONTROL_COLOR })
        this.createLink(mux2Port3, inBranch_Slt, [], { color: Scene.CONTROL_COLOR })
        this.createLink(mux2Port5, inBranch_MemToReg, [], { color: Scene.CONTROL_COLOR })
        ...
        this.createLink(mux2Port7, inBranch_Jalr, [[inBranch_Jalr.x, mux2Port7.y]], {
            color: Scene.CONTROL_COLOR,
        })
        ...
        this.createLink(pc4Port1, inBranch_Bot4, [
        ...
        this.createLink(dataGenPort0, inBranch_Bot3, [
        ...
        this.createLink(w_regPort4, inReg4, [
        ...
        this.createLink(outMux9, mux9Port0, [
            [outMux9.x + 1, outMux9.y],
            [outMux9.x + 1, mux9Port0.y],
        ])
        this.createLink(mux9Port0, mux9Port1)
        ...
        this.createLink(mux9Port0, inReg3, [
