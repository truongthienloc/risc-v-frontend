...
export default class Block implements IGraphObject, ILoader {
    ...
    public load({type = 'once', srcId, value}: InputData, callback?: (() => void) | undefined): void {
    ...
    public createPort(xt: number, yt: number, type: PortType, color?: string, name?: string): Port {
